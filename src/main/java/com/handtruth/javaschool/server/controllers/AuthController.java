...
public class AuthController {
    ...
    private Map<String, UserDetail> userDatabase = new HashMap<>();
    private Map<String, String> tokenTable = new HashMap<>();

    {
        userDatabase.put("admin@test.test", new UserDetail("Lexa", "Danilov", "20", "admin@test.test", "simple123456"));
    }
    ...
    public AuthResponse auth(@ModelAttribute @Valid UserDetail user) {
        ...
        if (userDatabase.containsKey(login) && userDatabase.get(login).getPassword().equals(password)) {
